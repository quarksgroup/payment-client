...
func (c *Client) do(ctx context.Context, method, path string, in, out interface{}, authRequired bool) (*client.Response, error) {
	req := &client.Request{
		Method: method,
		Path:   path,
	...
	case http.StatusUnauthorized:
		...
		return c.do(ctx, method, path, in, out, authRequired)
	default:
